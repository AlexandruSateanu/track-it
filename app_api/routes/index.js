...
//router.post('/proiect/:proiectId/editeaza-etape', auth, require('../controllers/proiect/editeazaEtape'));
//router.post('/proiect/:proiectId/editeaza-membri', auth, require('../controllers/proiect/editeazaMembri'));
